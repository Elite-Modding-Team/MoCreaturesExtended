...
public class MoCLegacyRenderLeoger extends MoCLegacyRenderBigCat {
    private static final ResourceLocation TEXTURE = new ResourceLocation(MoCConstants.MOD_ID, "textures/entity/big_cat/legacy/big_cat_leoger_legacy.png");

    public MoCLegacyRenderLeoger() {
