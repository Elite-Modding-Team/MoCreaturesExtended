...
public class MoCLegacyRenderLiger extends MoCLegacyRenderBigCat {
    private static final ResourceLocation TEXTURE = new ResourceLocation(MoCConstants.MOD_ID, "textures/entity/big_cat/legacy/big_cat_liger_legacy.png");

    public MoCLegacyRenderLiger() {
