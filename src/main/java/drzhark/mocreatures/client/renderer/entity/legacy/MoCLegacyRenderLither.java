...
public class MoCLegacyRenderLither extends MoCLegacyRenderBigCat {
    private static final ResourceLocation TEXTURE = new ResourceLocation(MoCConstants.MOD_ID, "textures/entity/big_cat/legacy/big_cat_lither_legacy.png");

    public MoCLegacyRenderLither() {
