...
public class MoCLegacyRenderPanthger extends MoCLegacyRenderBigCat {
    private static final ResourceLocation TEXTURE = new ResourceLocation(MoCConstants.MOD_ID, "textures/entity/big_cat/legacy/big_cat_panthger_legacy.png");

    public MoCLegacyRenderPanthger() {
